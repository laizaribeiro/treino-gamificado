...
//        var y = JSON.stringify(axEventObject);
        ...
        if ( (controle != 1) && (localStorage.codigo != "") && (localStorage.nome != "") && ($jobj('u7_input').val() != "") && (localStorage.terapeuta != "") ){
          ...
          $.ajax({
              type: 'POST',
              async: false,
              url: 'http://www.caed-lab.com/laiza/brasil/treino-gamificado/api_dados.php',
              data: {
        ...
        var instanteAtual = Date();
          ...
          $.ajax({
            type: 'POST',
            async: true,
            url: 'http://www.caed-lab.com/laiza/brasil/treino-gamificado/api_clique.php',
            data: {
            ...
            if(message == 'setGlobalVar') {
               ...
               if (data.globalVarValue != 0){
                  $.ajax({
                    type: 'POST',
                    async: true,
                    url: 'http://www.caed-lab.com/laiza/brasil/treino-gamificado/api_variavel.php',
                    data: {
                      'codigo': localStorage.codigo, // código do aluno
